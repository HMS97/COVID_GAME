    ...
    def __init__(self):
        self.sprite_parameters = {
            ...
            'sprite_flame': {
             ...
             'sprite_vaccine': {
                'sprite': pygame.image.load('sprites/vaccine/base/0.png').convert_alpha(),
                'viewing_angles': None,
                'shift': 0.7,
                'scale': (0.6, 0.6),
                'side': 30,
            ...
            'covid': {
                'sprite': [pygame.image.load(f'sprites/covid/base/{i}.png').convert_alpha() for i in range(8)],
                'viewing_angles': True,
                'shift': 0.0,
                'scale': (1.1, 1.1),
                'side': 50,
                'animation': [],
                'death_animation': deque([pygame.image.load(f'sprites/covid/death/{i}.png')
...
class SpriteObject:
    ...
    def object_locate(self, player):
        ...
        if 0 <= fake_ray <= FAKE_RAYS_RANGE and self.distance_to_sprite > 30:
            ...
            # logic for doors, adversary, npc, decor
